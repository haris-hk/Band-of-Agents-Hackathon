...
class ProviderSettings:
    ...
    max_run_usd: float # total dollar cap for the whole run
    max_run_tokens: int # total token cap for the whole run
    request_timeout_seconds: float
    max_prompt_tokens: int # cap on the input side only, before a request is sent
    max_agent_tokens: int # cap on the output side only, i.e. how many tokens we allow the model to generate per call
    aiml_model: str
